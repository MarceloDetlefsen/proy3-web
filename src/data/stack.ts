...
export const stack: StackItem[] = [
  ...
  { category: "Infra", name: "Vercel", percentage: 27 },
  { category: "Infra", name: "Docker", percentage: 9 },
  { category: "Infra", name: "Docker Compose", percentage: 9 },
  { category: "Infra", name: "Railway", percentage: 9 },
  { category: "Infra", name: "Cloudflare R2", percentage: 9 },
  { category: "Infra", name: "Cloudinary", percentage: 9 },
  { category: "Infra", name: "Clerk", percentage: 9 },
  { category: "Infra", name: "Axios", percentage: 9 },
]
